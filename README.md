...
| **Multi-agent swarm** (optional) | [Orchestrator–worker patterns](docs/guides/multi-agent-swarm.md), optional [extras skill](.agents/skills-extras/multi-agent-swarm/SKILL.md) | Agent context (and usually operational memory for handoffs).  |
