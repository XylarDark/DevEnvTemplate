...
exports.createActionableError = createActionableError;
exports.categorizeError = categorizeError;
exports.wrapError = wrapError;
exports.createJsonParseError = createJsonParseError;
 ...
 * ```
 */
function createActionableError(message, options = {}) {
 ...
 * ```
 */
function createJsonParseError(error, filePath) {
    return createActionableError(`Failed to parse JSON in ${filePath}`, {
        hints: [
 ...
 * ```
 */
function createFileNotFoundError(filePath, hint) {
    return createActionableError(`File not found: ${filePath}`, {
        hints: hint
            ? [hint]
            : [
