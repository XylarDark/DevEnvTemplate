...
class PerformanceTracker {
    ...
    setParallelMode(enabled, concurrency) {
    ...
    trackFileProcessed(filePath, size, processingTime, rulesApplied, cacheHit) {
    ...
    trackRuleExecution(ruleId, duration, filesAffected = 0, error = false) {
    ...
    generateReport() {
        ...
        const sortedRules = Array.from(this.ruleMetrics.values()).sort((a, b) => b.totalDuration - a.totalDuration);
