...
export type GapCategory = 'typescript' | 'linting' | 'testing' | 'security' | 'ci' | 'architecture' | 'quality' | 'observability' | 'documentation' | 'dependencies' | 'performance' | 'accessibility' | 'docker' | 'environment' | 'git-hooks' | 'git'
