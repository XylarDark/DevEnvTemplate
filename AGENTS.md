...
- **`.agents/skills/<name>/SKILL.md`** — core procedural knowledge (five skills). Each stays
...
read each turn to decide relevance. Five core skills currently cost about 350 tokens per turn on
top of this file's ~2,400, so the always-on budget is roughly 2,750 tokens in total. Extras in
